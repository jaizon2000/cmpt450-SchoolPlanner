...
df = pd.DataFrame(
    {
        "id": [course.id for course in all],
        "name": [course.name for course in all],
        "credit": [course.credit for course in all],
        "description": [course.desc for course in all]
